...
void my_server::run()
{
    ...
    while(!m_stopped)
    {
        ...
        // auto recvfrom_elapsed_time = std::chrono::duration_cast<std::chrono::milliseconds>(t2 - t1);
        // std::cout 
        //  << "recvfrom blocked for " /* << std::fixed << std::setprecision(2) */
        //  << recvfrom_elapsed_time.count() /* / 1000. */ 
        //  << "\n";
        ...
        // auto sendto_elapsed_time = std::chrono::duration_cast<std::chrono::milliseconds>(t4 - t3);
        // std::cout 
        //  << "sendto blocked for " /* << std::fixed << std::setprecision(2) */
        //  << sendto_elapsed_time.count() /* / 1000. */ 
        //  << "\n";
